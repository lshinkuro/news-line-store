...
const BottomNavbar = () => {
  ...
  return (
    <div className={`fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-blue-700 dark:border-blue-600 sm:hidden ${isVisible ? 'translate-y-0' : 'translate-y-20'}`}>
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto">  
        ...
        <Tooltip id="tooltip-home" text="Home" />

        <Link to="/ewallet" className="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <Tooltip id="tooltip-wallet" text="Wallet" />
        ...
        <Tooltip id="tooltip-new" text="Create new item" />
        
        <Link to="/contact" className="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <Tooltip id="tooltip-settings" text="Settings" />

        <Link to="/about" className="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <Tooltip id="tooltip-profile" text="Profile" />
      </div>
    </div>
  );
};
